        ...
        <div class="bg-primary p-12 md:p-16 text-center relative overflow-hidden shadow-md rounded-lg">
            ...
            <div class="relative z-10">
                ...
                <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
                    <a href="{{ $brand->whatsappUrl('Halo, saya ingin konsultasi tentang solusi tenaga surya SUOER.') ?: url('/kontak') }}" class="btn-fill w-full sm:w-auto bg-primary-container font-bold px-8 py-4 hover:scale-105 transition-transform shadow-lg inline-flex items-center justify-center gap-2 text-white rounded-lg">
